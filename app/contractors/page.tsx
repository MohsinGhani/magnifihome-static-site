    ...
    <div>
      <div className="mb-[10px] min-h-[50vh] px-5  ">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="mb-4">
            As a contractor, you’ve worked hard to build your reputation with
            your customers. Utilize these existing relationships with homeowners
            to enhance your product offering and forge deeper connections.
          </p>
          <p className="mb-4">
            We partner with home improvement contractors to create digital
            records for completed improvements in areas such as:
          </p>
          ...
          <p className="mb-4">
            Home improvement contractors are increasingly utilizing BLOCKDRIVE
          ...
          <p className="mb-4">
            ...
            used, date completed, warranty terms, etc.), and access to
            BLOCKDRIVE for a differentiated and value-added homeowner
            experience.
          </p>
          <p className="mb-4">
            <strong>Why?</strong>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              Provide a branding and closing opportunity that your competitors
              do not yet offer.
            </li>
          </ul>
        </div>
