      ...
      <div className="mb-[10px] min-h-[50vh] px-5  ">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="mb-4">
            ...
            warranty management tool. The BLOCKDRIVE can augment your
            relationship status with your network of clients to further solidify
            your position as their go-to real estate advisor.
          </p>
          <p className="mb-4">
            <strong>Why?</strong>
          </p>
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              Build deeper relationships across your network with a tool of
              value built for homeowners.
            </li>
            <li>
              Help build your clientele’s trust in your advisory service
              platform making you their first call.
            </li>
          </ul>
        </div>
