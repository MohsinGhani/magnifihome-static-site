  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <p className="mb-4">
          We want to help homeowners better access and capitalize on their real
          estate-related data.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          With over 60% of home mortgages in the U.S. fixed at an interest rate
          below 4%, moving homes will be cost prohibitive for many homeowners
          for the near future.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          These digital assets can be used and benefit the homeowner in numerous
          ways, including:
        </p>
        <ul className="list-disc pl-6 mb-4">
          <li>
            To index home improvements allowing homeowners better and more
            accurate property information which can be helpful to constituencies
            such as insurers and lenders / mortgage providers.
          </li>
          <li>To track warranty information for easy future access.</li>
          <li>
            To document building materials (brands, quantities, grades, colors,
